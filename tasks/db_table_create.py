...
CREATE TABLE stg_perf (
  ...
  RC_M1_SAA VARCHAR(50) NULL,
  RC_M1_TO_UE_CT VARCHAR(50) NULL,
  RC_M1_UE_CUS_CN VARCHAR(50),
  RC_M1_AV_NP_AT VARCHAR(50) NULL,
  APV_CE_RAT VARCHAR(50),
  DLV_SAA_RAT VARCHAR(50) NULL,
  M1_SME_RY_SAA_RAT VARCHAR(50) NULL,
  M1_SME_RY_CNT_RAT VARCHAR(50) NULL,
  M12_SME_RY_SAA_PCE_RT VARCHAR(50) NULL,
  M12_SME_BZN_SAA_PCE_RT VARCHAR(50) NULL,
  M12_SME_RY_ME_MCT_RAT VARCHAR(50) NULL,
  M12_SME_BZN_ME_MCT_RAT VARCHAR(50) NULL,
...
CREATE TABLE stg_demo (
  ENCODED_MCT VARCHAR(64),
  TA_YM CHAR(6),
  M12_MAL_1020_RAT VARCHAR(50) NULL,
  M12_MAL_30_RAT VARCHAR(50) NULL,
  M12_MAL_40_RAT VARCHAR(50) NULL,
  M12_MAL_50_RAT VARCHAR(50) NULL,
  M12_MAL_60_RAT VARCHAR(50) NULL,
  M12_FME_1020_RAT VARCHAR(50) NULL,
  M12_FME_30_RAT VARCHAR(50) NULL,
  M12_FME_40_RAT VARCHAR(50) NULL,
  M12_FME_50_RAT VARCHAR(50) NULL,
  M12_FME_60_RAT VARCHAR(50) NULL,
  MCT_UE_CLN_REU_RAT VARCHAR(50) NULL,
  MCT_UE_CLN_NEW_RAT VARCHAR(50) NULL,
  RC_M1_SHC_RSD_UE_CLN_RAT FLOAT NULL,
  RC_M1_SHC_WP_UE_CLN_RAT VARCHAR(50) NULL,
  RC_M1_SHC_FLP_UE_CLN_RAT FLOAT NULL,
  PRIMARY KEY (ENCODED_MCT, TA_YM)
);
...
DROP TABLE IF EXISTS mat_basic_crisis;
CREATE TABLE mat_basic_crisis(
  mct_id VARCHAR(64) PRIMARY KEY,
  addr VARCHAR(255),
  location POINT NULL,
...
DROP TABLE IF EXISTS mat_prompt_bundle_crisis;
CREATE TABLE mat_prompt_bundle_crisis (
  mct_id VARCHAR(64) PRIMARY KEY,
  addr VARCHAR(255),
  location POINT,
  close_rate_A DECIMAL(7, 5),
  close_rate_B DECIMAL(7, 5),
  close_rate_C DECIMAL(7, 5),
  resident_user DECIMAL(7, 5),
  floating_user DECIMAL(7, 5),
  UNIQUE KEY (mct_id)
);
"""
